...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserNewsRelation'
        db.create_table(u'UserNews_usernewsrelation', (
            ...
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='article', null=True, to=orm['NewsCollector.HackerNewsArticles'])),
            ('read', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'UserNews', ['UserNewsRelation'])


    def backwards(self, orm):
        # Deleting model 'UserNewsRelation'
        db.delete_table(u'UserNews_usernewsrelation')
    ...
    models = {
        ...
        u'UserNews.usernewsrelation': {
            'Meta': {'object_name': 'UserNewsRelation'},
            'article': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'article'", 'null': 'True', 'to': u"orm['NewsCollector.HackerNewsArticles']"}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),

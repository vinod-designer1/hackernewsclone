...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HackerNewsArticles.article_text'
        db.add_column(u'NewsCollector_hackernewsarticles', 'article_text',
                      self.gf('django.db.models.fields.TextField')(max_length=5000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HackerNewsArticles.article_text'
        db.delete_column(u'NewsCollector_hackernewsarticles', 'article_text')
